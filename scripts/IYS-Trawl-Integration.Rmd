...
#TODO: correct issues around discrepant scientific name spellings

#TODO be consistent with how sex is represented eg: Male vs m, Femaled vs f

#TODO make length measurements consistently mm or cm
#TODO figure length type for NW explorer
#TODO Convert all specimen weights to grams
...
IYS_CTD <- IYS_CTD |> 
  select(station_event_ID, instrument_type, sampling_depth_meters,
         sea_water_temperature_degC, sea_water_salinity_PSU, `sea_water_density_kg/m3`, sea_water_sigmaT)
...
IYS_CTD_w_metadata <- right_join(IYS_events, IYS_CTD, by = "station_event_ID")

write_csv(IYS_CTD_w_metadata, here("output_datasets", "IYS_CTD_and_events.csv"))
```
