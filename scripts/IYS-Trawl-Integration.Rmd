...
TINRO_CTD <- read_excel(here("input_datasets", "IYS2022_TINRO_Data.xlsx"), sheet = "7. CTD INFO") |> 
  ...
  left_join(select(filter(TINRO_event, event_type == "CTD"), station_event_id, latitude_start_decdeg), by = c("station_event_ID" = "station_event_id")) |> 
...
writexl::write_xlsx(out, here("IYS_Integratedd_Data_Collection.xlsx"))
```
