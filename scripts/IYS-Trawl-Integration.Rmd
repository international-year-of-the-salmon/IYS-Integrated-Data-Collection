...
GoA2019_event <- read_excel(here("input_datasets",
                            ...
                            sheet = "BRIDGE_LOG_FINAL") %>% filter(EVENT_TYPE == "Trawl")
...
GoA2019_specimen <- read_excel(here("input_datasets", "JuvSalmon_2019-01_Specimens_v21.01b_SUBMITTED_COPY (2).xlsx"),
