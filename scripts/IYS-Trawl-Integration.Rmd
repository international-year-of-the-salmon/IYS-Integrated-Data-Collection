...
janitor::compare_df_cols(NW_event, TINRO_event, Shimada_event, GoA2019_event, GoA2020_event)
```
...
# Check for differences in column header names and class between those two data frames:
janitor::compare_df_cols(NW_event, TINRO_event, Shimada_event, GoA2019_event)

# Join the individual event data frames and make all column names :
IYS2022_events <- bind_rows(TINRO_event, NW_event, Shimada_event, GoA2019_event) |> 
...
#TODO Include 2022 Franklin Catch
