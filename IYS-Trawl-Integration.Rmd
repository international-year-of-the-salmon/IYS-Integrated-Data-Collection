...
merge <- left_join(GoA2019_specimen, GoA2019_catch, by = c("Station_Event_ID", "Scientific_Name"))
merge2 <- left_join(GoA2019_catch, GoA2019_specimen, by = c("Station_Event_ID", "Scientific_Name"))
